...
def get_Redshift_connection():
    ...
    redshift_user = "sosb0421"  # 본인 ID 사용
    redshift_pass = "Sosb0421!1"  # 본인 Password 사용
    port = 5439
    dbname = "dev"
...
def load(lines):
    ...
    sql = "BEGIN;DELETE FROM sosb0421.name_gender;"
    for l in lines:
        if l != '':
            (name, gender) = l.split(",")
            sql += f"INSERT INTO sosb0421.name_gender VALUES ('{name}', '{gender}');"
    sql += "END;"
    logging.info(sql)
    """
